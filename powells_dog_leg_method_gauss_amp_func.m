...
clc
%**************************************************************************
% generate experimental gauss function with amplitude
%**************************************************************************
...
%**************************************************************************
% initial fitting parameters - amplitude, center, width, offset
%**************************************************************************
% initial amplitude
x01=1;
% initial center
...
%**************************************************************************
% fit simulated curve
fit_result=powells_dog_leg_gauss_amp(t_data, y_data, x0, k_max, epsilon_1, epsilon_2, epsilon_3, delta);
%**************************************************************************
...
% fitting parameters - amplitude, center, width, offset), k_max (maximum number of
...
%**************************************************************************
function [x_new] = powells_dog_leg_gauss_amp(t_data, y_data, x0, k_max, epsilon_1, epsilon_2, epsilon_3, delta)
    %**************************************************************************
    % begin of function
    %**************************************************************************
    ...
    while ((~found_bool) & (k < k_max))
        ...
        if (h_dl_norm <= epsilon_2*(x_norm+epsilon_2))
            ...
            % calculate F(x_new)
            f=zeros(1,M);
            f=y_data(1,:)-x_new(1,1)*exp(((-1.0)*((t_data(1,:)-x_new(1,2)).^2)./(2*x_new(1,3)^2)))-x_new(1,4);
