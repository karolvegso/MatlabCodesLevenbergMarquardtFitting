%**************************************************************************
% This algorithm performs Powell's dog leg method fitting on cosinus function
% author: Karol Vegso
...
clc
%**************************************************************************
% generate experimental cosinus function
% number of experimental points
M=100;
% parameters of cosinus function
% amplitude
a=125.6;
% phase
b=pi/3;
...
%**************************************************************************
% fit simulated curve
fit_result=powells_dog_leg_cosinus(t_data, y_data, x0, k_max, epsilon_1, epsilon_2, epsilon_3, delta);
%**************************************************************************
% function to perform Powell's dog leg fitting method on cosinus
% function
...
%**************************************************************************
function [x_new] = powells_dog_leg_cosinus(t_data, y_data, x0, k_max, epsilon_1, epsilon_2, epsilon_3, delta)
    %**************************************************************************
    % begin of function
    %**************************************************************************
    ...
    while ((~found_bool) & (k < k_max))
        ...
        if (h_dl_norm <= epsilon_2*(x_norm+epsilon_2))
            ...
            % calculate F(x_new)
            f=zeros(1,M);
            f=y_data(1,:)-x_new(1,1)*cos(t_data(1,:)+x_new(1,2))-x_new(1,3);
